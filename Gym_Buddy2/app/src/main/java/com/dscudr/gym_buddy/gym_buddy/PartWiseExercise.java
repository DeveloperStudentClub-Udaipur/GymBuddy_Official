...
public class PartWiseExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (id) {
            case 0:
                adapter = new Adapter(this, chest, name, "chest");
                getSupportActionBar().setTitle("Chest");
                break;
            case 1:
                adapter = new Adapter(this, biceps, name, "biceps");
                getSupportActionBar().setTitle("Biceps");
                break;
            case 2:
                adapter = new Adapter(this, back, name, "back");
                getSupportActionBar().setTitle("Back");
                break;
            case 3:
                adapter = new Adapter(this, triceps, name, "triceps");
                getSupportActionBar().setTitle("Triceps");
                break;
            case 4:
                adapter = new Adapter(this, legs, name, "legs");
                getSupportActionBar().setTitle("Legs");
                break;
            case 5:
                adapter = new Adapter(this, shoulder, name, "shoulder");
                getSupportActionBar().setTitle("Shoulder");
                break;
            case 6:
                adapter = new Adapter(this, abs, name, "abs");
                getSupportActionBar().setTitle("Abs");
                break;

        }

        recyclePartWise.setAdapter(adapter);
        int col;
